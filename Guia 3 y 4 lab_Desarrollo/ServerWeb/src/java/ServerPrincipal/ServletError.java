...
public class ServletError extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        Integer codigoEstado = (Integer)request.getAttribute("jakarta.servelet.error.status_code");
        String nombreServlet = (String)request.getAttribute("jakarta.servlet.error.servlet_name");
        String actionURL = (String)request.getAttribute("jakarta.servlet.error.request_url");
